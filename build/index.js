import { a as use, b as html, c as translate, d as $$1, e as registerTranslateConfig, f as render, g as get } from './vendor.js';
...
use('en');
render(index_template(), document.body);
...
// chrome.storage.sync.clear();
    ...
    var sb = new SelectionBox($$1('#exclude_cities'));
            ...
            for (var setting in auto_settings) {
                switch (setting) {
                    case 'currency':
                        ...
                        break;
                    case 'lang':
                        set_lang_value(auto_settings.lang[0]);
                        break;
                    case 'origin_city':
    ...
    function set_currency_value(value) {
        ...
        currency_selector = new DropDown($$1('#choose_currency'));
    }
    ...
    function set_lang_value(value) {
        ...
        lang_selector = new DropDown($$1('#choose_lang'));
        ...
        for (var key in settings) {
            switch (key) {
                ...
                case 'currency':
                    ...
                    break;
                case 'lang':
                    set_lang_value(settings.lang[0]);
                    break;
            }
        }
